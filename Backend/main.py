...
import pandas as pd
from routers import predict, analyze, allocate, recommend, heatai  # import routers
...
# app.include_router(heatai.router)  
...
async def root():
    return {
        ...
        "status": "running",
        "endpoints": ["/predict", "/analyze", "/recommend-method", "/allocate", "/ccts", "/heatai"]
    }
